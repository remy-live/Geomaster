...
const GROUPES = [
  ...
  ['Dessins au compas', [
    ['Trace un chat', { pts: VIDE }],
    ['Trace un panda', { pts: VIDE }],
    ...
    ['Trace un cœur', { pts: VIDE }],
    ['Trace un chat de 5 cm', { pts: VIDE }],
  ]],
  ['Les fiches de dessins géométriques', [
    ['Trace une étoile à 5 branches', { pts: VIDE }],
    ['Trace une étoile à 6 branches', { pts: VIDE }],
    ['Trace une étoile à 8 branches', { pts: VIDE }],
    ['Trace une étoile à 8 branches de 2 en 2', { pts: VIDE }],
    ["Trace le contour d'une étoile à 5 branches", { pts: VIDE }],
    ['Trace une étoile à 12 branches de 5 cm', { pts: VIDE }],
    ['Trace une spirale du carré', { pts: VIDE }],
    ['Trace une spirale du carré de 12 quarts', { pts: VIDE }],
    ['Trace un papier polaire', { pts: VIDE }],
    ['Trace une cible à 16 rayons et 4 cercles', { pts: VIDE }],
  ]],
  ['Cercles (suite)', [
  ...
  ['Quadrilatères et polygones', [
    ['Trace un carré ABCD de 3 cm de côté', { pts: VIDE }],
    ...
    ['Trace un pentagone ABCDE de 3 cm de côté', { pts: VIDE }],
    ['Trace un hexagone ABCDEF de 3 cm de côté', { pts: VIDE }],
  ...
  ['Mesures, codages, couleurs', [
    ...
    ['Code les longueurs égales', { pts: VIDE, prep: ['Trace un carré ABCD de 3 cm de côté'], genre: 'agit' }],
    'Trace [AB] en bleu',
    'Trace un carré rouge',
    'Trace un rectangle bleu en pointillé',
    ['Trace un carré ABCD rempli en vert', { pts: VIDE }],
